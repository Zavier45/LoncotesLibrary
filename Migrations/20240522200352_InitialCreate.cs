    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "35 Kitty Cat Claws Ct", "clawcouture@catpress.com", "Maus", true, "Tiddlywinks" },
                    { 2, "5684 Dog Bone Blvd", "samthewise@doggonit.com", "Samwise", true, "Joubert" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, "A Magic Steeped In Poison", 1, null },
                    { 2, 3, "Mansfield Park", 3, null },
                    { 3, 2, "Gideon the Ninth", 1, null },
                    { 4, 1, "History Begins At Sumer", 1, new DateTime(2020, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 5, 5, "Oppenheimer", 2, null },
                    { 6, 1, "The Conquest of Peru", 1, null },
                    { 7, 3, "The Princess Bride", 2, null },
                    { 8, 5, "A Woman of No Importance", 1, null },
                    { 9, 5, "Rasputin: Saint, Satyr, or Satan", 1, null },
                    { 10, 4, "Hell Followed With Us", 1, null }
                });
